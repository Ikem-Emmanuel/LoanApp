<template>
  <div class="w-full">
    <div class="font-sans bg-grey-lighter flex flex-col">
      <div>
        <div class="bg-blue">
              ...
              <div class="w-1/4 md:w-auto md:flex text-right">
                <div>
                  <img
                    ...
                    src="https://avatars2.githubusercontent.com/u/18678527?s=460&u=8d1e3088e194b57a128547a441001b8e23a1af71&v=4"
                    alt=""
                  />
                </div>
                <div class="hidden md:flex md:items-center ml-2">
                  <span class="text-white text-sm mr-1">Ikem Imarnoel</span>
                  <div>
                    <svg
    ...
    <div>
      <div v-show="isOpen" class="bg-blue md:block md:bg-light-normal">
        <div class="container mx-auto px-4">
          <div class="md:flex">
            <div class="flex -mb-px mr-8">
              <a
                href="#"
                class="no-underline text-gray-hard md:text-blue flex items-center py-4 border-b border-blue"
              >
                <svg
            ...
            <div class="flex -mb-px mr-8">
              <a
                href="#"
                class="no-underline text-gray-medium opacity-50 md:text-grey-dark md:opacity-100 flex items-center py-4 border-b border-transparent hover:opacity-100 md:hover:border-blue"
              >
                <svg
                  class="h-6 w-6 fill-current mr-2"
                  xmlns="http://www.w3.org/2000/svg"
